...
public class Article extends AggregatedData {
	...
	public Article(int id, int website_id, String title, String heading, String eyelet, String summary, String text, String author, String source, Date date){
	...
	public Article(Map<String, String> from_storage){
		super(from_storage.get("title"), from_storage.get("heading"), from_storage.get("eyelet"), from_storage.get("summary"),
				from_storage.get("text"), from_storage.get("author"), from_storage.get("url"), new Date(from_storage.get("date")));
